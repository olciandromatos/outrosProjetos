...
public class ProdutoBean {
	...
	public void carregarListagem() {
		...
		try {
			...
			itens = dao.listar();
			JSFUtil.addMenssagemSucesso("listado com sucesso");
	...
	public void novo() {
		...
		try {
			...
			dao.salvar(produto);
			itens = dao.listar();
			JSFUtil.addMenssagemSucesso("Produto salvo com sucesso!");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			JSFUtil.addMenssagemErro(e.getMessage());
	...
	public void excluir() {
		...
		try {
			...
			dao.excluir(produto);
			itens = dao.listar();
			JSFUtil.addMenssagemSucesso("Produto removido com sucesso");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			JSFUtil.addMenssagemErro(e.getMessage());
